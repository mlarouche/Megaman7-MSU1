...
normalize -a -18dBFS opening_part1.wav
normalize -a -18dBFS opening_part2.wav
normalize -a -18dBFS title_screen.wav
normalize -a -18dBFS intro_stage.wav
normalize -a -18dBFS bass_theme.wav
normalize -a -18dBFS password.wav
normalize -a -18dBFS stage_select.wav
normalize -a -18dBFS stage_start.wav
normalize -a -18dBFS freeze_man.wav
normalize -a -18dBFS burst_man.wav
normalize -a -18dBFS cloud_man.wav
normalize -a -18dBFS junk_man.wav
normalize -a -18dBFS robot_museum.wav
normalize -a -18dBFS shade_man.wav
normalize -a -18dBFS turbo_man.wav
normalize -a -18dBFS slash_man.wav
normalize -a -18dBFS spring_man.wav
normalize -a -18dBFS boss_battle1.wav
normalize -a -18dBFS boss_defeated.wav
normalize -a -18dBFS dr_light_lab.wav
normalize -a -18dBFS you_get_a_weapon.wav
normalize -a -18dBFS auto_shop.wav
normalize -a -18dBFS dr_light_lab_destroyed.wav
normalize -a -18dBFS dr_wily_castle.wav
normalize -a -18dBFS wily_stage1.wav
normalize -a -18dBFS wily_stage2.wav
normalize -a -18dBFS wily_stage3.wav
normalize -a -18dBFS wily_stage4.wav
normalize -a -18dBFS boss_battle2.wav
normalize -a -18dBFS wily_boss_battle.wav
normalize -a -18dBFS dr_wily_defeated.wav
normalize -a -18dBFS end_credits.wav
normalize -a -18dBFS shade_man_alternate_stage_selected.wav
normalize -a -18dBFS shade_man_alternate.wav
